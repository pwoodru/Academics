...
public class TestGameBoardMem {
    ...
    private IGameBoard MakeTestBoard(int row, int col, int numWin){
        return new GameBoardMem(row, col, numWin);
    }
    ...
    public void constructor_rows(){
        ...
        IGameBoard board = MakeTestBoard(3, 3, 4);
        int testRows = 3;
    ...
    public void checkSpace_colFilled(){
        ...
        expBoard[2][0] = 'X';
        String expected = toStringTemp(expBoard);
        assertTrue(board.checkSpace(marker3));
        assertEquals(expected, board.toString());
    }
    ...
    public void isPlayerAtPos_Center(){
        ...
        expBoard[1][1] = 'X';
        String expected = toStringTemp(expBoard);
        assertEquals(!board.isPlayerAtPos(marker, 'X'), true);
        assertEquals(expected, board.toString());
    }
