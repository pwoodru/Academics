...
public:
  ...
  // Virtual function
  /*making a function virtual tells the compiler that the compiler
   *should select the more specialized version of the getName() in the
   *derived class.  In otherwords, if a derived class overrides this function
   *the overridden function will be called.  If the derived class does not
   *override this function then this function will be called.  */
...
public:
  ...
  // Virtual function
  /*This function will be called when an instance of Tfaculty is allocated*/
